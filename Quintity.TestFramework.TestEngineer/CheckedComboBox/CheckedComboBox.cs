...
namespace Quintity.TestFramework.TestEngineer
{
    ...
    public partial class CheckedComboBox : PopupComboBox
    {
        ...
        {
            InitializeComponent();
            _CheckBoxProperties = new CheckedBoxProperties();
            ...
            CheckedComboBoxListControlContainer ContainerControl = new CheckedComboBoxListControlContainer();
            _CheckBoxComboBoxListControl = new CheckedComboBoxListControl(this);
        ...
        /// </summary>
        internal CheckedComboBoxListControl _CheckBoxComboBoxListControl;
        /// <summary>
        ...
        internal string GetCSVText(bool skipFirstItem)
        {
            ...
            {
                CheckedComboBoxItem Item = _CheckBoxComboBoxListControl.Items[Index];
                if (Item.Checked)
        ...
        /// </summary>
        [Browsable(false)]
        public CheckedComboBoxItemList CheckBoxItems
        {
            get 
            { 
        ...
        {
            foreach (CheckedComboBoxItem Item in CheckBoxItems)
                if (Item.Checked)
                    Item.Checked = false;
        }
        ...
        private CheckedBoxProperties _CheckBoxProperties;
        ...
        [Browsable(true)]
        public CheckedBoxProperties CheckBoxProperties
        {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CheckedComboBoxListControlContainer : UserControl
    {
        #region CONSTRUCTOR

        public CheckedComboBoxListControlContainer()
            : base()
        {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CheckedComboBoxListControl : ScrollableControl
    {
        #region CONSTRUCTOR

        public CheckedComboBoxListControl(CheckedComboBox owner)
            : base()
        {
            DoubleBuffered = true;
            _CheckBoxComboBox = owner;
            _Items = new CheckedComboBoxItemList(_CheckBoxComboBox);
            BackColor = SystemColors.Window;
            // AutoScaleMode = AutoScaleMode.Inherit;
            AutoScroll = true;
            ResizeRedraw = true;
        ...
        /// </summary>
        private CheckedComboBox _CheckBoxComboBox;
        /// <summary>
        /// A Typed list of ComboBoxCheckBoxItems.
        /// </summary>
        private CheckedComboBoxItemList _Items;

        #endregion

        public CheckedComboBoxItemList Items { get { return _Items; } }
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            {
                CheckedComboBoxItem Item = _Items[Index];
            ...
            CheckedComboBoxItemList NewList = new CheckedComboBoxItemList(_CheckBoxComboBox);
            for(int Index0 = 0; Index0 <= _CheckBoxComboBox.Items.Count - 1; Index0 ++)
            {
                object Object = _CheckBoxComboBox.Items[Index0];
                CheckedComboBoxItem Item = null;
                ...
                if (Item == null)
                {
                    Item = new CheckedComboBoxItem(_CheckBoxComboBox, Object);
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CheckedComboBoxItem : CheckBox
    {
        #region CONSTRUCTOR
        ...
        public CheckedComboBoxItem(CheckedComboBox owner, object comboBoxItem)
            : base()
        {
            DoubleBuffered = true;
            _CheckBoxComboBox = owner;
        ...
        internal void ApplyProperties(CheckedBoxProperties properties)
        {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class CheckedComboBoxItemList : List<CheckedComboBoxItem>
    {
        #region CONSTRUCTORS

        public CheckedComboBoxItemList(CheckedComboBox checkBoxComboBox)
        {
        ...
        public new void Add(CheckedComboBoxItem item)
        {
            item.CheckedChanged += new EventHandler(item_CheckedChanged);
            base.Add(item);
        }

        public new void AddRange(IEnumerable<CheckedComboBoxItem> collection)
        {
            foreach (CheckedComboBoxItem Item in collection)
                Item.CheckedChanged += new EventHandler(item_CheckedChanged);
        ...
        /// </summary>
        public CheckedComboBoxItem this[string displayName]
        {
            get
            {
                int StartIndex =
                ...
                {
                    CheckedComboBoxItem Item = this[Index];
    ...
    public class CheckedBoxProperties
    {
        public CheckedBoxProperties() { }
